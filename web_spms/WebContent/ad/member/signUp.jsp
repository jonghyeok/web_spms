...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <style>
  #draggable {float: right; /* width: 150px; height: 150px; padding: 0.5em;*/ }
  </style>
  <script>
  $(function() {
    $( "#draggable" ).draggable();
...
<div id="draggable" bgcolor=#EFEDF8>
	<div id=logo>
	</div>
	<div>
		<form id="signup" action="signup" method="post">
			...
			<input type='text' name='name' placeholder='* Name' required>
			 ...
			 <input type="text" name="blog" placeholder="Blog URL">
			  ...
			  <input type="number" name="level"placeholder="Level" title="0=stuendt,  1=Admin,   2=PM   (default=0)">
