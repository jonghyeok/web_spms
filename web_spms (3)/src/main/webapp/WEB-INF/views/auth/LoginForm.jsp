...
<!-- zzzzzzzzzzzzzzzz ë©ëª¨ ì¤í¬ë¦½í¸ ìì -->
<style type="text/css">
*{
  margin:0;
  padding:0;
...
<!-- zzzzzzzzzzzzzzzz ë©ëª¨ ì¤í¬ë¦½í¸ ì¢ë£ -->




<!--   dddddddddddddddddddëëê·¸ ì¤í¬ë¦½í¸ ììddddddddddddddddd -->
<style>
...
<!-- ddddddddddddddddddëëê·¸ ì¤í¬ë¦½í¸ ì¢ë£dddddddddddddd -->
<body>
 ...
 <ul>
    <li>
      <a href="loginForm.do"  class="drag">
        <h2>*Version Info*</h2>
        <p>Now Version is web_spms v131001_final</p><br>
      </a>
    </li>
    <li>
      <a href="loginForm.do"  class="drag">
